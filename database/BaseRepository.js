...
let BaseRepository = class BaseRepository {
    ...
    count(query) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield DB_1.DB.db.collection(this.entityName).count(query);
        });
    }
    findAndSort(query, sortQuery, skipLimit) {
        return __awaiter(this, void 0, void 0, function* () {
            this.normalizeSearchQuery(query);
            let queryBuild = DB_1.DB.db.collection(this.entityName).find(query);
            if (sortQuery) {
            ...
            let result = yield queryBuild.toArray();
    ...
    delete(entity) {
        return __awaiter(this, void 0, void 0, function* () {
            let objt = entity;
            let objId = this.deserializeObjectId(objt.id);
            yield this.collection().deleteOne({ _id: objId });
            return true;
        });
    }
    deleteByQuery(query) {
