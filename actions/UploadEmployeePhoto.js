...
class Action extends ActionBase_1.ActionBase {
    ...
    execute(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let employeeFromDb = yield this.employeeRepository.findByQuery({ id: context.params.employeeId });
            employeeFromDb.imageUrl = imageUrl;
...
//# sourceMappingURL=UploadEmployeePhoto.js.map